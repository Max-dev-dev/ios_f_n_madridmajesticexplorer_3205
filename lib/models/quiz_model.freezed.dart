...
class _$QuizItemImpl implements _QuizItem {
  const _$QuizItemImpl({
    ...
    @JsonKey(name: 'answer_d') required this.answerD,
  ...
  @override
  String toString() {
    return 'QuizItem(image: $image, question: $question, answerA: $answerA, answerB: $answerB, answerC: $answerC, answerD: $answerD, rightAnswer: $rightAnswer)';
  }
...
abstract class _QuizItem implements QuizItem {
  const factory _QuizItem({
    ...
    @JsonKey(name: 'answer_c') required final String answerC,
    @JsonKey(name: 'answer_d') required final String answerD,
